...
export default function Index({auth, packages, features, success, error}){
    ...
    return <>
        <AuthenticatedLayout user={auth.user} header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight"> your credits</h2>}>
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg relative">
                        <div className="p-4 flex flex-col gap-3 items-center text-yellow-500">
                            ...
                            <h3> You have {available_credits} credits.</h3>
                        </div>  
                    </div>
